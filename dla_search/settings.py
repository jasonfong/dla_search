"""
Django settings for dla_search project.
...
ROOT_URLCONF = 'dla_search.urls'

WSGI_APPLICATION = 'dla_search.wsgi.application'
...
CACHES = {
    'default': {
        'BACKEND': 'dla_search.gae_memcache.GoogleMemcachedCache',
    }
}
